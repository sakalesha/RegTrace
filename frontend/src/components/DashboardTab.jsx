...
export default function DashboardTab({ documentId }) {
  ...
  const cards = [
    ...
    { label: "Tasks Assigned", value: stats.tasks?.assigned || 0, color: "var(--moss)" },
    { label: "Tasks Completed", value: stats.tasks?.completed || 0, color: "var(--moss)" },
    { label: "Tasks Pending", value: stats.tasks?.pending || 0, color: "var(--slate)" },
    ...
    { label: "High Risk Gaps", value: stats.gaps?.high_risk || 0, color: "var(--rust)" },
    { label: "Medium Risk Gaps", value: stats.gaps?.medium_risk || 0, color: "var(--gold)" },
    { label: "Low Risk Gaps", value: stats.gaps?.low_risk || 0, color: "var(--slate)" },
